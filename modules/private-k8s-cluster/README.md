...
|------|-------------|------|---------|:--------:|
| <a name="input_cluster_autoscaling_max_cpu"></a> [cluster\_autoscaling\_max\_cpu](#input\_cluster\_autoscaling\_max\_cpu) | The maximum CPU for the cluster autoscaler and used across all node pools | `string` | `"8"` | no |
| <a name="input_cluster_autoscaling_max_memory_gb"></a> [cluster\_autoscaling\_max\_memory\_gb](#input\_cluster\_autoscaling\_max\_memory\_gb) | The maximum memory for the cluster autoscaler and used across all node pools | `string` | `"32"` | no |
...
| <a name="input_master_authorized_cidr_blocks"></a> [master\_authorized\_cidr\_blocks](#input\_master\_authorized\_cidr\_blocks) | The CIDR blocks allowed to connect to the master node | <pre>list(object({<br/>    cidr_block   = string<br/>    display_name = string<br/>  }))</pre> | <pre>[<br/>  {<br/>    "cidr_block": "10.0.0.7/32",<br/>    "display_name": "Network 1"<br/>  },<br/>  {<br/>    "cidr_block": "192.168.1.0/24",<br/>    "display_name": "Network 2"<br/>  }<br/>]</pre> | no |
...
| <a name="input_node_pool_name"></a> [node\_pool\_name](#input\_node\_pool\_name) | The name of the cluster node pool | `string` | n/a | yes |
...
| <a name="input_total_max_node_count"></a> [total\_max\_node\_count](#input\_total\_max\_node\_count) | The maximum number of nodes to create in a node pool | `number` | `3` | no |
| <a name="input_total_min_node_count"></a> [total\_min\_node\_count](#input\_total\_min\_node\_count) | The minimum number of nodes to create in a node pool | `number` | `1` | no |
