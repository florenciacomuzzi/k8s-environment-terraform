...
| <a name="input_node_pools"></a> [node\_pools](#input\_node\_pools) | The node pools to create | <pre>list(object({<br/>    name                 = string<br/>    node_disk_size_gb    = string<br/>    node_machine_type    = string<br/>    total_min_node_count = total_min_node_count<br/>    total_max_node_count = total_max_node_count<br/>  }))</pre> | <pre>[<br/>  {<br/>    "name": "gke-node-pool",<br/>    "node_disk_size_gb": 10,<br/>    "node_machine_type": "e2-standard-2",<br/>    "total_max_node_count": 3,<br/>    "total_min_node_count": 1<br/>  }<br/>]</pre> | no |
